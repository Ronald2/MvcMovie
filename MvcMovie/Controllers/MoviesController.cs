...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        // GET: Movies
        public ActionResult Index(string GenreSearch, string searchString)
        {
            var GenreLst = new List<string>();

            var GenreQur = from g in db.Movies
                           select g.Genre;

            GenreLst.AddRange(GenreQur.Distinct());
            ...
            {
                moviesList = moviesList.Where(g => g.Genre.Equals(GenreSearch));
            }
